...
- [Lab 3](#lab-3) - Site 2 Site Proveance
  - Starting a second NiFi Instance
  - Preparing for Provence Events
  - Sending the data
- [Lab 4](#lab-4) - MiNiFi
  ...
  - Preparing the flow
  - Running MiNiFi
- [Lab 5](#lab-5) - Kafka Basics
  - Creating a topic
  - Producing data
  - Consuming data
- [Lab 6a](#lab-6a) - Integrating Kafka with NiFi
  - Creating the Kafka topic
  - Adding the Kafka producer processor
  - Verifying the data is flowing
- [Lab 6b](#lab-6b) - Storm Basics
